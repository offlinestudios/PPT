...
for(const [key,item] of Object.entries(catalog)){
 ...
 d.head.innerHTML='<meta charset="utf-8">'+head+'<link rel="stylesheet" href="css/landing.css?v=1">';
 ...
 for(const name of Object.keys(scripts))d.body.insertAdjacentHTML('beforeend','<script charset="utf-8" src="js/landing-'+name+'.js?v=2"></script>');
